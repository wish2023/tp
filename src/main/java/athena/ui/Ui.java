...
public class Ui {
    ...
    public void printAthenaLogo() {
        System.out.println(color.toPurple("     ___   .__________.  __    __   _______ .__   __.      ___      \n"
                + "    /   \\  |          | |  |  |  | |   ____||  \\ |  |     /   \\     \n"
                + "   /  ^  \\ `---|  |---` |  |__|  | |  |__   |   \\|  |    /  ^  \\    \n"
                + "  /  /_\\  \\    |  |     |   __   | |   __|  |  . `  |   /  /_\\  \\   \n"
                + " /  _____  \\   |  |     |  |  |  | |  |____ |  |\\   |  /  _____  \\  \n"
    ...
    public void printWelcomeMessage() {
        System.out.println(color.toPurple("Hello! I'm the Goddess of Wisdom and War, the mighty ATHENA!\n" + "...\n"
    ...
    public void printTaskAdded(String taskName, String taskStartTime, String taskDuration, String taskDeadline,
        ...
        System.out.println("You've successfully added " + color.toBlue(taskName) + " to your list!\n"
                + "It will start at " + color.toBlue(taskStartTime) + " and finish on "
                + color.toBlue(taskDeadline) + ".\n"
                + "You should spend a total of " + color.toBlue(taskDuration) + " on it.\n"
                + "It is set to happen " + color.toBlue(taskRecurrence) + " and has an importance of "
                + color.toBlue(taskImportance) + ".\n"
                + "Additionally, you've also added these notes!\n" + color.toBlue(taskNotes) + ".\n"
    ...
    public void printTaskDone(Task task) {
        System.out.println("A job well done! I've slayed the-- I mean, marked the task "
                + color.toBlue(task.getName()) + " as complete!\n");
    }
    ...
    public void printTaskEdited(int taskIndex, String taskName, String taskStartTime, String taskDuration,
                                ...
                                String taskNotes) {
        System.out.println("You've changed the details of task number " + color.toBlue(Integer.toString(taskIndex))
                + ": " + color.toBlue(taskName) + "!\n"
                + "Here are the new details of your task!\n"
                + "Start Time: " + color.toBlue(taskStartTime) + "\n"
                + "Duration: " + color.toBlue(taskDuration) + "\n"
                + "Due Date: " + color.toBlue(taskDeadline) + "\n"
                + "Recurrence: " + color.toBlue(taskRecurrence) + "\n"
                + "Importance: " + color.toBlue(taskImportance.name()) + "\n"
                + "Additional Notes: " + color.toBlue(taskNotes) + "\n"
    ...
    public void printTaskDeleted(Task task, String taskRestore) {
        System.out.println("Are we pretending the task " + color.toBlue(task.toString())
    ...
    public void printTaskDetails(String taskDetails) {
        System.out.println("Here are the details of your task: " + color.toBlue(taskDetails));
    }
    ...
    public void printHelp() {
        System.out.println(color.toYellow("Not sure of what I'm capable of doing? "
    ...
    public void printInvalidTask() {
        System.out.println(color.toRed("One of the tasks in the archives seems to be cursed, "
    ...
    public void printTaskNotFound(int taskNumber) {
        System.out.println(color.toRed("The task with the label ")
                + color.toRed(Integer.toString(taskNumber)) + color.toRed(" cannot be found\n"));
    }
    ...
    public void printAddMissingRequiredParametersException() {
        System.out.println(color.toRed("You haven't specified the name or the start time of the task! "
    ...
    public void printDeleteInvalidIndexException() {
        System.out.println(color.toRed("Hmm...not sure what you're trying to delete, "
    ...
    public void printDeleteNoIndexException() {
        System.out.println(color.toRed("So you're trying to delete a task...but which one exactly? "
    ...
    public void printDoneInvalidIndexException() {
        System.out.println(color.toRed("I'm not sure if you're trying to smoke me or smoke yourself, "
                + "but there is no task at that index. "
    ...
    public void printDoneNoIndexException() {
        System.out.println(color.toRed("I know you're really eager, but you need to specify "
    ...
    public void printViewInvalidIndexException() {
        System.out.println(color.toRed("I'm not sure if you're trying to smoke me or "
    ...
    public void printEditNoIndexException() {
        System.out.println(color.toRed("You need to specify the correct index of the task "
                + "you want to edit!\n"));
    ...
    public void printInvalidCommandException() {
        System.out.println(color.toRed("I know I'm really smart but even I don't know what "
                + "you're requesting. Maybe if you type ") + color.toYellow("help")
                + color.toRed(", you can see what the valid commands are.\n"));
    }
    ...
    public void printEmptyTaskListException() {
        System.out.println(color.toRed("You don't have any tasks in your list! You should probably add some in if "
    ...
    public void printExitMessage() {
        System.out.println(color.toPurple("Going so soon? Well I'll be here the next time you need me. "
                + "Farewell!\n"));
    }
